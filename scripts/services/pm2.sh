...
exec /sbin/setuser node pm2 start /var/www/node/server.js -i 0 --node-args="--max-old-space-size=250" --name "connectingThings-app" -l /var/log/nodejs/pm2.log --no-daemon
